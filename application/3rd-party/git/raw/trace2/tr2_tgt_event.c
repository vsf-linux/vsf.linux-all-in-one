...
#ifdef __VSF__
struct __git_trace2_tgt_event_ctx_t {
	struct tr2_dst __tr2dst_event;					// = { TR2_SYSENV_EVENT, 0, 0, 0, 0 };
	int __tr2env_event_max_nesting_levels;			// = 2;
	int __tr2env_event_be_brief;
};
void __git_trace2_tgt_event_mod_init(void *ctx);
define_vsf_git_mod(git_trace2_tgt_event,
	sizeof(struct __git_trace2_tgt_event_ctx_t),
	GIT_MOD_TRACE2_TGT_EVENT,
	__git_trace2_tgt_event_mod_init
)
#	define git_trace2_tgt_event_ctx	((struct __git_trace2_tgt_event_ctx_t *)vsf_git_ctx(git_trace2_tgt_event))

#	define tr2dst_event				(git_trace2_tgt_event_ctx->__tr2dst_event)
#	define tr2env_event_max_nesting_levels	(git_trace2_tgt_event_ctx->__tr2env_event_max_nesting_levels)
#	define tr2env_event_be_brief	(git_trace2_tgt_event_ctx->__tr2env_event_be_brief)
#else
...
#ifdef __VSF__
static void __git_trace2_tgt_event_mod_init(void *ctx)
{
	struct __git_trace2_tgt_event_ctx_t *__git_trace2_tgt_event_ctx = ctx;
	__git_trace2_tgt_event_ctx->__tr2dst_event = (struct tr2_dst){ TR2_SYSENV_EVENT, 0, 0, 0, 0 };
	__git_trace2_tgt_event_ctx->__tr2env_event_max_nesting_levels = 2;
	tr2_tgt_event = (struct tr2_tgt) {
#else
const struct tr2_tgt tr2_tgt_event = {
#endif
	&tr2dst_event,
...
static void __git_trace2_tgt_mod_init(void *ctx)
{
	declare_vsf_git_mod(git_trace2_tgt_event)
	declare_vsf_git_mod(git_trace2_tgt_normal)
	declare_vsf_git_mod(git_trace2_tgt_perf)
	vsf_git_ctx(git_trace2_tgt_event);
	vsf_git_ctx(git_trace2_tgt_normal);
	vsf_git_ctx(git_trace2_tgt_perf);
}
define_vsf_git_mod(git_trace2_tgt,
	sizeof(struct __git_trace2_tgt_ctx_t),
	GIT_MOD_TRACE2_TGT,
	__git_trace2_tgt_mod_init
)
#endif
